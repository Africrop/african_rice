...
scp -rp nas:/$path_to_dir/100_ind_Mcswan.txt $path_to_tmp/
scp -rp nas:/$path_to_dir/functions_daf.R $path_to_tmp/
scp -rp nas:/$path_to_dir/creation_sfs2d_rice_real_data_Mcswan.R $path_to_tmp/
...
Rscript $path_to_tmp/creation_sfs2d_rice_real_data_Mcswan.R
