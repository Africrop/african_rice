...
smc++ estimate -o /data2/projects/africrop_models/Rice_smcpp/output_ob_fold/ --tK 100000 6.5e-9 /data2/projects/africrop_models/Rice_smcpp/data/*ob.smc.masked*
smc++ estimate -o /data2/projects/africrop_models/Rice_smcpp/output_ob_fold_regpen6/ --tK 100000 --regularization-penalty 6 6.5e-9 /data2/projects/africrop_models/Rice_smcpp/data/*ob.smc.masked*