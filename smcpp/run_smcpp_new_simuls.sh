...
smc++ estimate -o /data2/projects/africrop_models/Rice_smcpp/new_simuls/bottleneck/output/ 6.5e-9 /data2/projects/africrop_models/Rice_smcpp/new_simuls/bottleneck/*.smc.*