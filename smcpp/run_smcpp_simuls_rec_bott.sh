...
smc++ estimate -o /data2/projects/africrop_models/Rice_smcpp/simuls/rec_bott/output_unfold/ --tK 100000 6.5e-9 /data2/projects/africrop_models/Rice_smcpp/simuls/rec_bott/*.smc.*