...
for i in `cat /data2/projects/africrop_models/Rice_smcpp/list_of_pseudo_diploids_Og.txt`;
do smc++ vcf2smc -m /data2/projects/africrop_models/Rice_smcpp/mask_final.bed.gz -d $i $i /data2/projects/africrop_models/Rice_smcpp/Rice_pseudodiplos_AllChr.vcf.gz /data2/projects/africrop_models/Rice_smcpp/data/chr$1.og.smc.masked.$i.gz Chr$1 `cat /data2/projects/africrop_models/Rice_smcpp/Og_list_smcpp.txt`;
done
