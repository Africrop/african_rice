...
for i in {1..12}
do for j in {1..10}
do smc++ vcf2smc -d IND$j IND$j --length 20000000 /data2/projects/africrop_models/Rice_smcpp/new_simuls/bottleneck/simulated.bottleneck.vcf.gz /data2/projects/africrop_models/Rice_smcpp/new_simuls/bottleneck/simulated.bottleneck.chr$i.smc.$j.gz Chr$i `cat /data2/projects/africrop_models/Rice_smcpp/list_simulated.smcpp.txt`
done
done
