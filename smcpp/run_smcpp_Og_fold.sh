...
smc++ estimate -o /data2/projects/africrop_models/Rice_smcpp/output_og_fold/ --tK 100000 6.5e-9 /data2/projects/africrop_models/Rice_smcpp/data/*og.smc.masked*
smc++ estimate -o /data2/projects/africrop_models/Rice_smcpp/output_og_fold_regpen6/ --tK 100000 --regularization-penalty 6 6.5e-9 /data2/projects/africrop_models/Rice_smcpp/data/*og.smc.masked*