...
for i in {1..12}
do for j in {1..10}
do smc++ vcf2smc -d IND$j IND$j --length 20000000 /data2/projects/africrop_models/Rice_smcpp/new_simuls/rec_bott/rec.bott.simulated.vcf.gz /data2/projects/africrop_models/Rice_smcpp/new_simuls/rec_bott/simulated.chr$i.rec.bott.smc.$j.gz Chr$i `cat /data2/projects/africrop_models/Rice_smcpp/list_simulated.smcpp.txt`
done
done
