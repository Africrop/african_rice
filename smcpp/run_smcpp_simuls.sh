...
smc++ estimate -o /data2/projects/africrop_models/Rice_smcpp/simuls/bottleneck/output_unfold/ --tK 100000 6.5e-9 /data2/projects/africrop_models/Rice_smcpp/simuls/bottleneck/*.smc.*